  ...
  return (
    <section className="flex flex-col items-center gap-8 lg:gap-12 pt-8 lg:pt-20 pb-0 px-4 lg:px-[236px] relative self-stretch w-full flex-[0_0_auto]">
      ...
      <div className="hidden lg:block shirose-fanclub-article-scaler w-full max-w-[968px] min-h-0 -mt-[6px]">
        <article className="shirose-fanclub-article flex flex-col w-full min-h-0 lg:w-[968px] lg:h-[648px] lg:min-h-[648px] items-start gap-2.5 p-0 lg:p-2 relative lg:bg-black-000 border-0 lg:border-8 lg:border-solid lg:border-transparent lg:[border-image:linear-gradient(180deg,rgba(176,123,11,1)_0%,rgba(255,230,145,1)_53%,rgba(176,123,11,0.69)_97%)_1] lg:-ml-[8px]">
          {/* PC: 固定サイズの2カラムレイアウト（article全体のscaleで縮小される） */}
          <div className="hidden lg:flex flex-col lg:flex-row items-stretch justify-end gap-0 relative w-[952px] h-[632px] -mt-[8px] lg:-ml-[8px] flex-shrink-0">
          <div className="flex flex-col w-[525px] flex-shrink-0 lg:h-[632px] items-stretch justify-end overflow-hidden min-w-0">
            <div className="w-full flex-1 min-h-0 overflow-hidden flex items-start justify-center lg:min-h-[380px]">
              <img
                className="relative max-w-full max-h-full w-full h-auto aspect-[612/408] object-contain object-top lg:object-cover lg:min-h-[380px] lg:h-[380px] lg:w-auto"
                alt="SHIROSE ファンクラブの写真"
                src="https://c.animaapp.com/h73j2KJP/img/231004-164.png"
              />
            </div>

            <div className="flex w-full h-[164px] lg:h-[194px] flex-shrink-0 items-center justify-center gap-2.5 px-4 lg:px-[22px] py-[34px] relative bg-[url(https://c.animaapp.com/h73j2KJP/img/frame-90.png)] bg-cover bg-[50%_50%]">
          ...
          <div className="flex flex-col w-[427px] flex-shrink-0 items-stretch gap-7 relative overflow-hidden min-w-0 lg:h-[632px]">
