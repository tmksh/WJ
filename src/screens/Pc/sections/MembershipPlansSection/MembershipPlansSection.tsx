...
/** 水色ドア ホバー画像（英語・中国語はPNGで差し替え、日本語は現状のSVGのまま） */
const DOOR_MIZU_PC: Record<Lang, string> = {
  ja: "/img/door-mizu-pc.svg",
  en: "/img/door-mizu-pc-en.png",
  zh: "/img/door-mizu-pc-zh.png",
};
const DOOR_MIZU_SP: Record<Lang, string> = {
  ja: "/img/door-mizu-sp.svg",
  en: "/img/door-mizu-sp-en.png",
  zh: "/img/door-mizu-sp-zh.png",
};
...
export const MembershipPlansSection = (): JSX.Element => {
  ...
  const membershipButtons: Array<{ titleKey: "plans_title"; subtitleKey: string | null }> = [
    { titleKey: "plans_title", subtitleKey: null },
  ];
      ...
      <header className="flex flex-col w-full max-w-[720px] items-center gap-4 lg:gap-3 relative flex-[0_0_auto]">
        <div className="flex self-stretch w-full flex-col items-center justify-center gap-4 relative flex-[0_0_auto]">
          <div className="inline-flex flex-col min-h-[86px] items-center justify-center gap-2 lg:gap-3 relative w-full max-w-[720px]">
            <h2 className="relative w-fit [font-family:'Noto_Sans_JP',Helvetica] font-extrabold text-text text-[22px] lg:text-[36px] text-center tracking-[0] leading-[1.2] whitespace-nowrap" data-i18n="plans_title">
              {t("plans_title")}
            </h2>

            <p className="text-text text-[16px] leading-[1.5] relative w-fit [font-family:'Noto_Sans_JP',Helvetica] font-extrabold text-center tracking-[0]" data-i18n="plans_subtitle">
              {t("plans_subtitle")}
              <br />
              {t("plans_subtitle2")}
            </p>
        ...
        <div className="inline-flex items-center gap-4 relative flex-[0_0_auto]">
          ...
          <p className="w-fit mt-[-1.00px] font-black text-main text-[30px] lg:text-[50px] text-center leading-[30px] lg:leading-[50px] relative [font-family:'Noto_Sans_JP',Helvetica] tracking-[0]" data-i18n="plans_join_text" style={{ whiteSpace: "pre-line" }}>
            {t("plans_join_text")}
          </p>
        ...
        <div className="flex items-center justify-center relative self-stretch w-full max-w-[464px] lg:max-w-none flex-[0_0_auto] mx-auto">
          {membershipButtons.map((button, index) => (
            ...
            >
              ...
              {button.subtitleKey && (
                <span className="self-stretch font-bold text-main text-[10px] text-center leading-[10px] relative [font-family:'Noto_Sans_JP',Helvetica] tracking-[0]" data-i18n={button.subtitleKey}>
        ...
        <div className="flex flex-col lg:flex-row items-center lg:items-start gap-6 lg:gap-10 relative self-stretch w-full flex-[0_0_auto] lg:flex-1 lg:min-w-0 membership-plans-scaler-inner">
          <article className="flex flex-col w-full max-w-[464px] lg:flex-1 lg:min-w-0 lg:max-w-full items-center gap-6 pt-0 pb-6 px-4 lg:px-0 mx-6 lg:mx-0 relative overflow-hidden rounded-[20px_20px_0px_0px] border-4 border-solid border-light-blue bg-[#F7F6F3]" style={{ backgroundColor: "#F7F6F3" }}>
            <div className="benefit-card-header flex items-center justify-center gap-2.5 p-4 relative self-stretch w-[calc(100%+32px)] lg:w-full lg:min-w-0 flex-[0_0_auto] bg-light-blue rounded-[16px_16px_0px_0px] -mx-4 lg:mx-0">
              <h3 className="benefit-card-title w-fit mt-[-1.00px] font-extrabold text-white text-[24px] lg:text-[32px] text-center leading-[38.4px] whitespace-nowrap relative [font-family:'Noto_Sans_JP',Helvetica] tracking-[0]" data-i18n="plans_web_fanclub">
                {t("plans_web_fanclub")}
              </h3>
            </div>
              ...
              <div className="inline-flex items-end gap-6 relative flex-[0_0_auto] w-full lg:w-full lg:min-w-0 lg:flex-wrap lg:gap-4 lg:justify-center">
                <div className="inline-flex flex-col items-start gap-6 relative flex-[0_0_auto] w-fit lg:flex-[0_1_auto] lg:min-w-[216px] lg:max-w-full">
                  <div className="flex flex-col w-fit max-w-full lg:w-full lg:max-w-[282px] lg:min-w-0 items-start gap-3 relative flex-[0_0_auto]">
                    ...
                    <p className="w-fit lg:self-stretch font-bold text-text text-[12px] lg:text-[14px] text-justify leading-[19.6px] relative [font-family:'Noto_Sans_JP',Helvetica] tracking-[0]" data-i18n="plans_newsletter">
                      {t("plans_newsletter")}
                    </p>
                  </div>
          ...
          <div className="flex flex-col w-full max-w-[464px] lg:flex-1 lg:min-w-0 lg:max-w-[464px] items-center gap-[19px] relative">
            <h3 className="relative self-stretch mt-[-1.00px] font-bold text-text text-[24px] lg:text-[32px] leading-8 [font-family:'Noto_Sans_JP',Helvetica] text-center tracking-[0]" data-i18n="plans_benefits_title">
              {t("plans_benefits_title")}
            </h3>
